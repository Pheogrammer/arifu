...
<div class="az-content az-content-profile">
    <div class="container mn-ht-100p">
      <div class="az-content-left az-content-left-profile" style="margin-left:1%;">

        <div class="az-profile-overview">
          <div class="az-img-user">
            <img src="{{asset('rsc/img/faces/face10.jpg')}}" alt="">
          </div><!-- az-img-user -->
          <div class="d-flex justify-content-between mg-b-20">
            <div>
              <h5 class="az-profile-name text-capitalise">{{auth()->user()->name}}</h5>
            </div>
